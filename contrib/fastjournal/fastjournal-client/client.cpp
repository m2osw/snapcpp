 ...
 *
 * This file starts the Fast Journal Client service. This server connects
 * to the Fast Journal Backend service and sends data saved in a local file.
 */
 ...
 *
 * This table includes all the options supported by fastjournal-client
 * on the command line.
 */
...
advgetopt::options_environment const g_options_environment =
{
    ...
    .f_help_footer = "This server is started on the client's side where you save batch requests in a file.\n",
