...
/** \file
 * \brief The fast journal libray version.
 *
 * This file handles the fast journal library version.
 *
...
{
    return LIBFASTJOURNAL_VERSION_MAJOR;
}
...
{
    return LIBFASTJOURNAL_VERSION_MINOR;
}
...
{
    return LIBFASTJOURNAL_VERSION_PATCH;
}
...
{
    return LIBFASTJOURNAL_VERSION_STRING;
}
