 ...
 * or) operator to ensure full coverage and that all possible left
...
TEST_CASE("Expression value || value", "[expression] [logical-or]")
{
    struct value_t
    {
        char const *    f_string;
...
TEST_CASE("Expression invalid || invalid", "[expression] [logical-or] [invalid]")
{
