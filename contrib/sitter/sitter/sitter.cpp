...
public:
    typedef std::shared_ptr<messenger>    pointer_t;
                                ...
                                messenger(watchdog_server::pointer_t ws, addr::addr const & a);
 ...
 */
messenger::messenger(watchdog_server::pointer_t ws, addr::addr const & a)
 ...
 */
ed::dispatcher<watchdog_server>::dispatcher_match::vector_t const g_snapwatchdog_service_messages =
{
    {
        "CASSANDRAREADY"
 ...
 */
bool watchdog_server::send_message(ed::message const & message, bool cache)
{
...
void watchdog_server::msg_nocassandra(ed::message & message)
{
...
void watchdog_server::msg_cassandraready(ed::message & message)
{
    snapdev::NOT_USED(message);
...
void watchdog_server::msg_rusage(ed::message & message)
{
    // Can connect to Cassandra yet?
    //
    // We now support running without Cassandra
...
void watchdog_server::ready(ed::message & message)
{
    snapdev::NOT_USED(message);
...
void watchdog_server::msg_reload_config(ed::message & message)
{
    snapdev::NOT_USED(message);
