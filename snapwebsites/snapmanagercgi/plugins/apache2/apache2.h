...
private:
    void                    retrieve_status_of_snapmanagercgi_conf(snap_manager::server_status & server_status);
    void                    retrieve_status_of_snapcgi_conf(snap_manager::server_status & server_status);
