...
char const * get_name(name_t name)
{
    ...
    case name_t::SNAP_NAME_EPAYMENT_STRIPE_RETURN_PLAN_URL:
        return "epayment/stripe/return-plan";

    case name_t::SNAP_NAME_EPAYMENT_STRIPE_RETURN_URL:
        return "epayment/stripe/return";
    ...
    //    SECURE NAMES
    // ******************
    case name_t::SNAP_SECURE_NAME_EPAYMENT_STRIPE_ACTIVATED_PLAN:
        return "epayment_stripe::activated_plan";

    case name_t::SNAP_SECURE_NAME_EPAYMENT_STRIPE_ACTIVATED_PLAN_HEADER:
        return "epayment_stripe::activated_plan_header";

    case name_t::SNAP_SECURE_NAME_EPAYMENT_STRIPE_AGREEMENT_ID:
        return "epayment_stripe::agreement_id";

    case name_t::SNAP_SECURE_NAME_EPAYMENT_STRIPE_AGREEMENT_TOKEN:
        return "epayment_stripe::agreement_token";

    case name_t::SNAP_SECURE_NAME_EPAYMENT_STRIPE_AGREEMENT_URL:
        return "epayment_stripe::agreement_url";

    case name_t::SNAP_SECURE_NAME_EPAYMENT_STRIPE_BILL_PLAN:
        return "epayment_stripe::bill_plan";

    case name_t::SNAP_SECURE_NAME_EPAYMENT_STRIPE_BILL_PLAN_HEADER:
        return "epayment_stripe::bill_plan_header";

    case name_t::SNAP_SECURE_NAME_EPAYMENT_STRIPE_CHECK_BILL_PLAN:
        return "epayment_stripe::check_bill_plan";

    case name_t::SNAP_SECURE_NAME_EPAYMENT_STRIPE_CHECK_BILL_PLAN_HEADER:
        return "epayment_stripe::check_bill_plan_header";

    case name_t::SNAP_SECURE_NAME_EPAYMENT_STRIPE_CLIENT_ID:
        return "epayment_stripe::client_id";

    case name_t::SNAP_SECURE_NAME_EPAYMENT_STRIPE_CREATED_AGREEMENT:
        return "epayment_stripe::created_agreement";

    case name_t::SNAP_SECURE_NAME_EPAYMENT_STRIPE_CREATED_AGREEMENT_HEADER:
        return "epayment_stripe::created_agreement_header";

    case name_t::SNAP_SECURE_NAME_EPAYMENT_STRIPE_CREATED_PAYMENT:
        return "epayment_stripe::created_payment";

    case name_t::SNAP_SECURE_NAME_EPAYMENT_STRIPE_CREATED_PAYMENT_HEADER:
        return "epayment_stripe::created_payment_header";

    case name_t::SNAP_SECURE_NAME_EPAYMENT_STRIPE_CREATED_PLAN:
        return "epayment_stripe::created_plan";

    case name_t::SNAP_SECURE_NAME_EPAYMENT_STRIPE_CREATED_PLAN_HEADER:
        return "epayment_stripe::created_plan_header";

    case name_t::SNAP_SECURE_NAME_EPAYMENT_STRIPE_EXECUTE_AGREEMENT:
        return "epayment_stripe::execute_agreement";

    case name_t::SNAP_SECURE_NAME_EPAYMENT_STRIPE_EXECUTED_AGREEMENT:
        return "epayment_stripe::executed_agreement";

    case name_t::SNAP_SECURE_NAME_EPAYMENT_STRIPE_EXECUTED_AGREEMENT_HEADER:
        return "epayment_stripe::executed_agreement_header";

    case name_t::SNAP_SECURE_NAME_EPAYMENT_STRIPE_EXECUTED_PAYMENT:
        return "epayment_stripe::executed_payment";

    case name_t::SNAP_SECURE_NAME_EPAYMENT_STRIPE_EXECUTED_PAYMENT_HEADER:
        return "epayment_stripe::executed_payment_header";

    case name_t::SNAP_SECURE_NAME_EPAYMENT_STRIPE_EXECUTE_PAYMENT:
        return "epayment_stripe::execute_payment";

    case name_t::SNAP_SECURE_NAME_EPAYMENT_STRIPE_INVOICE_NUMBER:
        return "epayment_stripe::invoice_number";

    case name_t::SNAP_SECURE_NAME_EPAYMENT_STRIPE_INVOICE_SECRET_ID:
        return "epayment_stripe::invoice_secret_id";

    case name_t::SNAP_SECURE_NAME_EPAYMENT_STRIPE_OAUTH2_ACCESS_TOKEN:
        return "epayment_stripe::oauth2_access_token";

    case name_t::SNAP_SECURE_NAME_EPAYMENT_STRIPE_OAUTH2_APP_ID:
        return "epayment_stripe::oauth2_app_id";

    case name_t::SNAP_SECURE_NAME_EPAYMENT_STRIPE_OAUTH2_DATA:
        return "epayment_stripe::oauth2_data";

    case name_t::SNAP_SECURE_NAME_EPAYMENT_STRIPE_OAUTH2_EXPIRES:
        return "epayment_stripe::oauth2_expires";

    case name_t::SNAP_SECURE_NAME_EPAYMENT_STRIPE_OAUTH2_HEADER:
        return "epayment_stripe::oauth2_header";

    case name_t::SNAP_SECURE_NAME_EPAYMENT_STRIPE_OAUTH2_SCOPE:
        return "epayment_stripe::oauth2_scope";

    case name_t::SNAP_SECURE_NAME_EPAYMENT_STRIPE_OAUTH2_TOKEN_TYPE:
        return "epayment_stripe::oauth2_token_type";

    case name_t::SNAP_SECURE_NAME_EPAYMENT_STRIPE_PAYMENT_ID:
        return "epayment_stripe::payment_id";

    case name_t::SNAP_SECURE_NAME_EPAYMENT_STRIPE_PAYMENT_TOKEN:
        return "epayment_stripe::payment_token";

    case name_t::SNAP_SECURE_NAME_EPAYMENT_STRIPE_PAYER_ID:
        return "epayment_stripe::payer_id";

    case name_t::SNAP_SECURE_NAME_EPAYMENT_STRIPE_PLAN_ID:
        return "epayment_stripe::plan_id";

    case name_t::SNAP_SECURE_NAME_EPAYMENT_STRIPE_PLAN_URL:
        return "epayment_stripe::plan_url";

    case name_t::SNAP_SECURE_NAME_EPAYMENT_STRIPE_REPEAT_PAYMENT:
        return "epayment_stripe::repeat_payment";

    case name_t::SNAP_SECURE_NAME_EPAYMENT_STRIPE_SANDBOX_CLIENT_ID:
        return "epayment_stripe::sandbox_client_id";

    case name_t::SNAP_SECURE_NAME_EPAYMENT_STRIPE_SANDBOX_SECRET:
        return "epayment_stripe::sandbox_secret";
...
/** \brief First update to run for the epayment_stripe plugin.
 *
 * This function is the first update for the epayment_stripe plugin.
 ...
 */
void epayment_stripe::initial_update(int64_t variables_timestamp)
{
    NOTUSED(variables_timestamp);

    get_epayment_stripe_table();
    f_epayment_stripe_table.reset();
}
...
void epayment_stripe::bootstrap(snap_child * snap)
{
    ...
    SNAP_LISTEN(epayment_stripe, "server", server, process_post, _1);
 ...
 */
void epayment_stripe::on_process_post(QString const & uri_path)
{
    // make sure this is a cart post
    char const * clicked_post_field(get_name(name_t::SNAP_NAME_EPAYMENT_STRIPE_CLICKED_POST_FIELD));
    ...
    if(click == "checkout")
    {
        // "checkout" -- the big Stripe button in the Checkout screen
        //               we start a payment with Stripe
        ...
        //if(r != 1)
        //{
        //    throw epayment_stripe_exception_io_error("RAND_bytes() could not generate a random number.");
        //}
        //QtCassandra::QCassandraValue rnd_value(reinterpret_cast<char const *>(rnd), static_cast<int>(sizeof(rnd)));
        //secret_row->cell(get_name(name_t::SNAP_SECURE_NAME_EPAYMENT_STRIPE_INVOICE_SECRET_ID))->setValue(rnd_value);
        //QString const rnd_hex(rnd_value.binaryValue().toHex());
        //users_plugin->attach_to_session(get_name(name_t::SNAP_SECURE_NAME_EPAYMENT_STRIPE_INVOICE_SECRET_ID), rnd_hex);
        //http_cookie cookie(f_snap, "snap_epayment_stripe", rnd_hex);
        //f_snap->set_cookie(cookie);

        //
        // Documentation directly in link with the following:
        //    https://developer.stripe.com/webapps/developer/docs/integration/web/accept-stripe-payment/
        //

        // first we need to "log in", which Stripe calls
        ...
        // before we can send the user to Stripe we need to know whether
        ...
        for(size_t idx(0); idx < max_products; ++idx)
        {
            ...
            else if(product.has_property(epayment::get_name(epayment::name_t::SNAP_NAME_EPAYMENT_RECURRING)))
            {
                ...
                if(recurring_defined)
                {
                    ...
                    //       an invoice; in this case we'd add Stripe; the
                    ...
                    messages::messages::instance()->set_error(
                        ...
                        "The Stripe payment facility does not support a purchase with more than one subscription.",
        ...
        if(recurring_defined)
        {
            if(other_items)
            {
                ...
                messages::messages::instance()->set_error(
                    ...
                    "A Stripe payment does not support regular items and a subscription to be processed together.",
            ...
            // recurring payments at Stripe make use of a plan
            ...
            //
            // curl -v POST https://api.sandbox.stripe.com/v1/payments/billing-agreements
            //      -H 'Content-Type: application/json'
            //      -H 'Authorization: Bearer <Access-Token>'
            //      -d '{
            ...
            //                          },
            //                      "max_fail_attempts":"0",
            //                      "return_url":"http://csnap.m2osw.com/epayment/stripe/return-plan",
            //                      "cancel_url":"http://csnap.m2osw.com/epayment/stripe/cancel",
            //                      "auto_bill_amount":"NO",
            //                      "initial_fail_amount_action":"CANCEL"
            //                  }
            ...
            //              [
            //                  {
            //                      "href":"https://www.sandbox.stripe.com/cgi-bin/webscr?cmd=_express-checkout&token=EC-123",
            //                      "rel":"approval_url",
            //                      "method":"REDIRECT"
            //                  },
            //                  {
            //                      "href":"https://api.sandbox.stripe.com/v1/payments/billing-agreements/EC-123/agreement-execute",
            //                      "rel":"execute",
            //                      "method":"POST"
            //                  }
            //              ],
            ...
            //          make sure to add a setup fee.
            {
                ...
                time_t now;
                time(&now);
                now += 60;  // +1 minute, otherwise Stripe may say it has to be in the future
                struct tm t;
                gmtime_r(&now, &t);
...
<< "\n***\n";
            ...
            bool const debug(get_debug());
            create_agreement_request.set_host(debug ? "api.sandbox.stripe.com" : "api.stripe.com");
            ...
            create_agreement_request.set_header("Stripe-Request-Id", invoice_ipath.get_key().toUtf8().data());
            ...
            secret_row->cell(get_name(name_t::SNAP_SECURE_NAME_EPAYMENT_STRIPE_CREATED_AGREEMENT_HEADER))->setValue(QString::fromUtf8(response->get_original_header().c_str()));
            secret_row->cell(get_name(name_t::SNAP_SECURE_NAME_EPAYMENT_STRIPE_CREATED_AGREEMENT))->setValue(QString::fromUtf8(response->get_response().c_str()));
            ...
            if(object.find("plan") == object.end())
            {
                ...
                throw epayment_stripe_exception_io_error("plan object missing in agreement");
            }
            ...
            if(plan.find("state") == plan.end())
            {
                ...
                throw epayment_stripe_exception_io_error("plan status missing in agreement");
            }
            // TODO: the case should not change, but Stripe suggest you test
            //       statuses in a case insensitive manner
            ...
            {
                epayment_plugin->set_invoice_status(invoice_ipath, epayment::name_t::SNAP_NAME_EPAYMENT_INVOICE_STATUS_FAILED);
                SNAP_LOG_ERROR("Stripe plan status is not \"ACTIVE\" as expected when creating an agreement");
                throw epayment_stripe_exception_io_error("Stripe plan status is not \"ACTIVE\" as expected when creating an agreement");
            }
            ...
            for(size_t idx(0); idx < max_links; ++idx)
            {
                ...
                if(link_object.find("rel") != link_object.end())
                {
                    ...
                    if(rel == "approval_url")
                    {
                        ...
                        {
                            epayment_plugin->set_invoice_status(invoice_ipath, epayment::name_t::SNAP_NAME_EPAYMENT_INVOICE_STATUS_FAILED);
                            SNAP_LOG_ERROR("Stripe link \"approval_url\" has no \"method\" parameter");
                            throw epayment_stripe_exception_io_error("Stripe link \"approval_url\" has no \"method\" parameter");
                        }
                        if(link_object.at("method")->get_string() != "REDIRECT")
                        {
                            epayment_plugin->set_invoice_status(invoice_ipath, epayment::name_t::SNAP_NAME_EPAYMENT_INVOICE_STATUS_FAILED);
                            SNAP_LOG_ERROR("Stripe link \"approval_url\" has a \"method\" other than \"REDIRECT\"");
                            throw epayment_stripe_exception_io_error("Stripe link \"approval_url\" has a \"method\" other than \"REDIRECT\"");
                        }
                        if(link_object.find("href") == link_object.end())
                        {
                            epayment_plugin->set_invoice_status(invoice_ipath, epayment::name_t::SNAP_NAME_EPAYMENT_INVOICE_STATUS_FAILED);
                            SNAP_LOG_ERROR("Stripe link \"approval_url\" has no \"href\" parameter");
                            throw epayment_stripe_exception_io_error("Stripe link \"approval_url\" has no \"href\" parameter");
                        }
                        ...
                        {
                            epayment_plugin->set_invoice_status(invoice_ipath, epayment::name_t::SNAP_NAME_EPAYMENT_INVOICE_STATUS_FAILED);
                            SNAP_LOG_ERROR("Stripe link \"approval_url\" has no \"token\" query string parameter");
                            throw epayment_stripe_exception_io_error("Stripe link \"approval_url\" has no \"token\" query string parameter");
                        }
                        ...
                        epayment_stripe_table->row(main_uri.full_domain())->cell("agreement/" + token)->setValue(date_invoice);
                        secret_row->cell(get_name(name_t::SNAP_SECURE_NAME_EPAYMENT_STRIPE_AGREEMENT_TOKEN))->setValue(token);
                    }
                    else if(rel == "execute")
                    {
                        ...
                        {
                            epayment_plugin->set_invoice_status(invoice_ipath, epayment::name_t::SNAP_NAME_EPAYMENT_INVOICE_STATUS_FAILED);
                            SNAP_LOG_ERROR("Stripe link \"execute\" has no \"method\" parameter");
                            throw epayment_stripe_exception_io_error("Stripe link \"execute\" has no \"method\" parameter");
                        }
                        if(link_object.at("method")->get_string() != "POST")
                        {
                            epayment_plugin->set_invoice_status(invoice_ipath, epayment::name_t::SNAP_NAME_EPAYMENT_INVOICE_STATUS_FAILED);
                            SNAP_LOG_ERROR("Stripe link \"execute\" has a \"method\" other than \"POST\"");
                            throw epayment_stripe_exception_io_error("Stripe link \"execute\" has a \"method\" other than \"POST\"");
                        }
                        if(link_object.find("href") == link_object.end())
                        {
                            epayment_plugin->set_invoice_status(invoice_ipath, epayment::name_t::SNAP_NAME_EPAYMENT_INVOICE_STATUS_FAILED);
                            SNAP_LOG_ERROR("Stripe link \"execute\" has no \"href\" parameter");
                            throw epayment_stripe_exception_io_error("Stripe link \"execute\" has no \"href\" parameter");
                        }
                        as2js::String const& href(link_object.at("href")->get_string());
                        secret_row->cell(get_name(name_t::SNAP_SECURE_NAME_EPAYMENT_STRIPE_EXECUTE_AGREEMENT))->setValue(QString::fromUtf8(href.to_utf8().c_str()));
                        found_execute = true;
                    }
                }
            }
        ...
        else
        {
            if(recurring_fee_defined)
            {
                ...
                messages::messages::instance()->set_error(
                    "Unsupported Mix of Products",
                    "A standard Stripe payment cannot include a recurring fee.",
                    "Got recurring and non-recurring items in one invoice.",
                    false
                );
                return;
            ...
            //
            // Stripe example:
            //      curl -v https://api.sandbox.stripe.com/v1/payments/payment
            //          -H 'Content-Type: application/json'
            //          -H 'Authorization: Bearer <Access-Token>'
            //          -d '{
            //            "intent":"sale",
            ...
            //              "links": [
            //                  {
            //                      "href":"https://api.sandbox.stripe.com/v1/payments/payment/PAY-1234567890",
            //                      "rel":"self",
            //                      "method":"GET"
            //                  },
            //                  {
            //                      "href":"https://www.sandbox.stripe.com/cgi-bin/webscr?cmd=_express-checkout&token=EC-12345",
            //                      "rel":"approval_url",
            //                      "method":"REDIRECT"
            //                  },
            //                  {
            //                      "href":"https://api.sandbox.stripe.com/v1/payments/payment/PAY-1234567890/execute",
            //                      "rel":"execute",
            //                      "method":"POST"
            //                  }
            //              ]
            ...
            // so we create the array as required by Stripe but we do not
            // loop over it with "each transaction"
            {
                ...
                // AMOUNT (grand total, what we charge to the user)
                {
                    ...
                    // TOTAL (Stripe expects a string for total)
                    // TODO: the number of decimals depends on the currency
                    //       (from what I read it can be 0, 2, or 3)
                ...
                // ITEM LIST
                {
                    ...
                    // ITEMS
                    {
                        ...
                        //
                        // this is the full cart which Stripe now supports
                        ...
                        for(size_t idx(0); idx < max_products; ++idx)
                        {
                            ...
                            // QUANTITY (Stripe expects a string for quantity)
                            ...
                            // PRICE (Stripe expects a string for price)
                            // TODO: the number of decimals depends on the currency
                            //       (from what I read it can be 0, 2, or 3)
            ...
            // REDIRECT URLS
            {
                ...
                content::path_info_t return_url;
                return_url.set_path(get_name(name_t::SNAP_NAME_EPAYMENT_STRIPE_RETURN_URL));
                temp_str.from_utf8(return_url.get_key().toUtf8().data());
                field.reset(new as2js::JSON::JSONValue(pos, temp_str));
...
<< "]\n***\n";
            ...
            bool const debug(get_debug());
            payment_request.set_host(debug ? "api.sandbox.stripe.com" : "api.stripe.com");
            ...
            payment_request.set_header("Stripe-Request-Id", invoice_ipath.get_key().toUtf8().data());
            ...
            secret_row->cell(get_name(name_t::SNAP_SECURE_NAME_EPAYMENT_STRIPE_CREATED_PAYMENT_HEADER))->setValue(QString::fromUtf8(response->get_original_header().c_str()));
            secret_row->cell(get_name(name_t::SNAP_SECURE_NAME_EPAYMENT_STRIPE_CREATED_PAYMENT))->setValue(QString::fromUtf8(response->get_response().c_str()));
            ...
            && response->get_response_code() != 201)
            {
                ...
                throw epayment_stripe_exception_io_error("creating a sale payment failed");
            }
            ...
            || response->get_header("content-type") != "application/json")
            {
                ...
                throw epayment_stripe_exception_io_error("sale request did not return application/json data");
            }
            ...
            if(!value)
            {
                ...
                throw epayment_stripe_exception_io_error("JSON parser failed parsing sale response");
            }
            as2js::JSON::JSONValue::object_t const& object(value->get_object());
            ...
            if(object.find("state") == object.end())
            {
                ...
                throw epayment_stripe_exception_io_error("payment state missing");
            }
            // TODO: the case should not change, but Stripe suggest you test
            //       statuses in a case insensitive manner
            if(object.at("state")->get_string() != "created")
            {
                epayment_plugin->set_invoice_status(invoice_ipath, epayment::name_t::SNAP_NAME_EPAYMENT_INVOICE_STATUS_FAILED);
                SNAP_LOG_ERROR("Stripe payment status is not \"created\" as expected");
                throw epayment_stripe_exception_io_error("Stripe payment status is not \"created\" as expected");
            }
            ...
            if(object.find("id") == object.end())
            {
                ...
                throw epayment_stripe_exception_io_error("payment identifier missing");
            }
            as2js::String const& id_string(object.at("id")->get_string());
            QString const id(QString::fromUtf8(id_string.to_utf8().c_str()));
            secret_row->cell(get_name(name_t::SNAP_SECURE_NAME_EPAYMENT_STRIPE_PAYMENT_ID))->setValue(id);

            // save a back reference in the epayment_stripe table
            QString const date_invoice(QString("%1,%2").arg(f_snap->get_start_date()).arg(invoice_ipath.get_key()));
            epayment_stripe_table->row(main_uri.full_domain())->cell("id/" + id)->setValue(date_invoice);
            ...
            //       cookie must survive...
            users_plugin->attach_to_session(get_name(name_t::SNAP_SECURE_NAME_EPAYMENT_STRIPE_PAYMENT_ID), id);
            ...
            if(object.find("links") == object.end())
            {
                ...
                throw epayment_stripe_exception_io_error("payment links missing");
            }
            as2js::JSON::JSONValue::array_t const& links(object.at("links")->get_array());
            size_t const max_links(links.size());
            for(size_t idx(0); idx < max_links; ++idx)
            {
                ...
                if(link_object.find("rel") != link_object.end())
                {
                    ...
                    if(rel == "approval_url")
                    {
                        ...
                        // not the payment identifier!
                        QString const token(redirect_uri.query_option("token"));
                        epayment_stripe_table->row(main_uri.full_domain())->cell("token/" + token)->setValue(invoice_ipath.get_key());
                        secret_row->cell(get_name(name_t::SNAP_SECURE_NAME_EPAYMENT_STRIPE_PAYMENT_TOKEN))->setValue(token);
                    }
                    else if(rel == "execute")
                    {
                        // this is it! the URL to send the user to
                        ...
                        as2js::String const& href(link_object.at("href")->get_string());
                        secret_row->cell(get_name(name_t::SNAP_SECURE_NAME_EPAYMENT_STRIPE_EXECUTE_PAYMENT))->setValue(QString::fromUtf8(href.to_utf8().c_str()));
                        found_execute = true;
                    }
                }
            }
        ...
        {
            epayment_plugin->set_invoice_status(invoice_ipath, epayment::name_t::SNAP_NAME_EPAYMENT_INVOICE_STATUS_FAILED);
            throw epayment_stripe_exception_io_error("Stripe redirect URL (\"approval_url\") was not found");
        }
        if(!found_execute)
        {
            epayment_plugin->set_invoice_status(invoice_ipath, epayment::name_t::SNAP_NAME_EPAYMENT_INVOICE_STATUS_FAILED);
            throw epayment_stripe_exception_io_error("Stripe execute URL (\"execute\") was not found");
        }

        // now we are going on Stripe so the payment is pending...
    ...
    server_access_plugin->ajax_append_data(get_name(name_t::SNAP_NAME_EPAYMENT_STRIPE_TOKEN_POST_FIELD), click.toUtf8());
