...
public:
	...
	virtual void on_generate_main_content(layout *l, const QString& path, QDomElement& page, QDomElement& body) = 0;
};
...
public:
	...
	QString				apply_layout(const QString& cpath, layout_content *plugin);

	SNAP_SIGNAL(generate_header_content, (layout *l, const QString& path, QDomElement& header, QDomElement& metadata), (l, path, header, metadata));
	SNAP_SIGNAL(generate_page_content, (layout *l, const QString& path, QDomElement& page, QDomElement& body), (l, path, page, body));
