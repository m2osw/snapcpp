...
enum name_t
{
    ...
    SNAP_NAME_PERMISSIONS_LINK_BACK,
...
public:
    ...
    SNAP_SIGNAL_WITH_MODE(permit_redirect_to_login_on_not_allowed, (content::path_info_t& ipath, bool& redirect_to_login), (ipath, redirect_to_login), NEITHER);
