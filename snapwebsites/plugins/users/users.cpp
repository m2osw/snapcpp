...
void users::on_generate_page_content(layout::layout *l, QString const& path, QDomElement& page, QDomElement& body, QString const& ctemplate)
{
    ...
    QtCassandra::QCassandraRow::pointer_t content_row(content_table->row(page_key));
...
#pragma GCC diagnostic push
#pragma GCC diagnostic ignored "-Wunused-parameter"
void users::on_process_post(QString const& cpath, sessions::sessions::session_info const& info)
{
    if(cpath == "login")
    {
