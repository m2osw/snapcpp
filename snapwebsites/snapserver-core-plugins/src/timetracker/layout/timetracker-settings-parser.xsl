<?xml version="1.0"?>
<!--
Snap Websites Server == timetracker settings form parser
...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:variable name="layout-area">timetracker-settings-parser</xsl:variable>
	<xsl:variable name="layout-modified">2016-01-03 17:14:33</xsl:variable>
	<xsl:variable name="layout-editor">timetracker-settings-page</xsl:variable>

	<xsl:template match="snap">
		<output> <!-- lang="{$lang}" 'lang variable undefined' -->
			<div id="content" class="editor-form" form_name="timetracker_settings">
				...
				<div>
					...
					<fieldset class="calendar">
						...
						<div class="editor-block">
							<xsl:copy-of select="page/body/timetracker/week_first_day/node()"/>
						</div>
