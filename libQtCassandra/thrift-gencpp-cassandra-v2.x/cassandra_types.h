...
typedef struct _TimedOutException__isset {
  _TimedOutException__isset() : acknowledged_by(false), acknowledged_by_batchlog(false), paxos_in_progress(false) {}
  bool acknowledged_by;
  bool acknowledged_by_batchlog;
  bool paxos_in_progress;
} _TimedOutException__isset;

class TimedOutException : public ::apache::thrift::TException {
 public:

  static const char* ascii_fingerprint; // = "BCB1048B25A23A1B64C41A185F5F94DF";
  static const uint8_t binary_fingerprint[16]; // = {0xBC,0xB1,0x04,0x8B,0x25,0xA2,0x3A,0x1B,0x64,0xC4,0x1A,0x18,0x5F,0x5F,0x94,0xDF};

  TimedOutException() : acknowledged_by(0), acknowledged_by_batchlog(0), paxos_in_progress(0) {
  }
  ...
  void __set_paxos_in_progress(const bool val) {
    paxos_in_progress = val;
  ...
  bool operator == (const TimedOutException & rhs) const
  {
    ...
    if (__isset.acknowledged_by_batchlog != rhs.__isset.acknowledged_by_batchlog)
      ...
      return false;
    if (__isset.paxos_in_progress != rhs.__isset.paxos_in_progress)
      return false;
    else if (__isset.paxos_in_progress && !(paxos_in_progress == rhs.paxos_in_progress))
      return false;
    return true;
  }
  bool operator != (const TimedOutException &rhs) const {
...
typedef struct _CASResult__isset {
  _CASResult__isset() : current_values(false) {}
  bool current_values;
} _CASResult__isset;
...
class CASResult {
 public:
  ...
  static const char* ascii_fingerprint; // = "E89EE887E1C0328427E46E2DE2236FDA";
  static const uint8_t binary_fingerprint[16]; // = {0xE8,0x9E,0xE8,0x87,0xE1,0xC0,0x32,0x84,0x27,0xE4,0x6E,0x2D,0xE2,0x23,0x6F,0xDA};

  CASResult() : success(0) {
  }

  virtual ~CASResult() throw() {}

  bool success;
  std::vector<Column>  current_values;

  _CASResult__isset __isset;

  void __set_success(const bool val) {
    success = val;
  }

  void __set_current_values(const std::vector<Column> & val) {
    current_values = val;
    __isset.current_values = true;
  }

  bool operator == (const CASResult & rhs) const
  {
    if (!(success == rhs.success))
      return false;
    if (__isset.current_values != rhs.__isset.current_values)
      return false;
    else if (__isset.current_values && !(current_values == rhs.current_values))
      return false;
    return true;
  }
  bool operator != (const CASResult &rhs) const {
  ...
  bool operator < (const CASResult & ) const;
