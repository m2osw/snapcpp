...
class CassandraIf {
 public:
  ...
  virtual void cas(CASResult& _return, const std::string& key, const std::string& column_family, const std::vector<Column> & expected, const std::vector<Column> & updates, const ConsistencyLevel::type serial_consistency_level, const ConsistencyLevel::type commit_consistency_level) = 0;
  ...
  virtual void trace_next_query(std::string& _return) = 0;
  virtual void describe_splits_ex(std::vector<CfSplit> & _return, const std::string& cfName, const std::string& start_token, const std::string& end_token, const int32_t keys_per_split) = 0;
  ...
  virtual void execute_cql3_query(CqlResult& _return, const std::string& query, const Compression::type compression, const ConsistencyLevel::type consistency) = 0;
  virtual void prepare_cql_query(CqlPreparedResult& _return, const std::string& query, const Compression::type compression) = 0;
  virtual void prepare_cql3_query(CqlPreparedResult& _return, const std::string& query, const Compression::type compression) = 0;
  virtual void execute_prepared_cql_query(CqlResult& _return, const int32_t itemId, const std::vector<std::string> & values) = 0;
  virtual void execute_prepared_cql3_query(CqlResult& _return, const int32_t itemId, const std::vector<std::string> & values, const ConsistencyLevel::type consistency) = 0;
...
typedef struct _Cassandra_cas_args__isset {
  _Cassandra_cas_args__isset() : expected(false), updates(false) {}
  bool expected;
  bool updates;
} _Cassandra_cas_args__isset;

class Cassandra_cas_args {
 public:

  Cassandra_cas_args() : key(), column_family(), serial_consistency_level((ConsistencyLevel::type)9), commit_consistency_level((ConsistencyLevel::type)2) {
    serial_consistency_level = (ConsistencyLevel::type)9;

    commit_consistency_level = (ConsistencyLevel::type)2;

  }

  virtual ~Cassandra_cas_args() throw() {}

  std::string key;
  std::string column_family;
  std::vector<Column>  expected;
  std::vector<Column>  updates;
  ConsistencyLevel::type serial_consistency_level;
  ConsistencyLevel::type commit_consistency_level;

  _Cassandra_cas_args__isset __isset;
  ...
  void __set_expected(const std::vector<Column> & val) {
    expected = val;
  }

  void __set_updates(const std::vector<Column> & val) {
    updates = val;
  }

  void __set_serial_consistency_level(const ConsistencyLevel::type val) {
    serial_consistency_level = val;
  }

  void __set_commit_consistency_level(const ConsistencyLevel::type val) {
    commit_consistency_level = val;
  }

  bool operator == (const Cassandra_cas_args & rhs) const
  {
    if (!(key == rhs.key))
      return false;
    if (!(column_family == rhs.column_family))
      return false;
    if (!(expected == rhs.expected))
      return false;
    if (!(updates == rhs.updates))
      return false;
    if (!(serial_consistency_level == rhs.serial_consistency_level))
      return false;
    if (!(commit_consistency_level == rhs.commit_consistency_level))
      return false;
    return true;
  }
  bool operator != (const Cassandra_cas_args &rhs) const {
  ...
  bool operator < (const Cassandra_cas_args & ) const;
...
class Cassandra_cas_pargs {
 public:


  virtual ~Cassandra_cas_pargs() throw() {}

  const std::string* key;
  const std::string* column_family;
  const std::vector<Column> * expected;
  const std::vector<Column> * updates;
  const ConsistencyLevel::type* serial_consistency_level;
  const ConsistencyLevel::type* commit_consistency_level;

  uint32_t write(::apache::thrift::protocol::TProtocol* oprot) const;

};

typedef struct _Cassandra_cas_result__isset {
  _Cassandra_cas_result__isset() : success(false), ire(false), ue(false), te(false) {}
  bool success;
  bool ire;
  bool ue;
  bool te;
} _Cassandra_cas_result__isset;

class Cassandra_cas_result {
 public:

  Cassandra_cas_result() {
  }

  virtual ~Cassandra_cas_result() throw() {}
  ...
  _Cassandra_cas_result__isset __isset;

  void __set_success(const CASResult& val) {
    success = val;
  }
  ...
  bool operator == (const Cassandra_cas_result & rhs) const
  {
    if (!(success == rhs.success))
      return false;
    if (!(ire == rhs.ire))
  ...
  bool operator < (const Cassandra_cas_result & ) const;
...
typedef struct _Cassandra_cas_presult__isset {
  _Cassandra_cas_presult__isset() : success(false), ire(false), ue(false), te(false) {}
  bool success;
  bool ire;
  bool ue;
  bool te;
} _Cassandra_cas_presult__isset;

class Cassandra_cas_presult {
 public:


  virtual ~Cassandra_cas_presult() throw() {}
  ...
  _Cassandra_cas_presult__isset __isset;
...
class Cassandra_atomic_batch_mutate_args {
 public:
  ...
  Cassandra_atomic_batch_mutate_args() : consistency_level((ConsistencyLevel::type)1) {
    consistency_level = (ConsistencyLevel::type)1;

  }

  virtual ~Cassandra_atomic_batch_mutate_args() throw() {}
  ...
  bool operator == (const Cassandra_atomic_batch_mutate_args & rhs) const
  {
    if (!(mutation_map == rhs.mutation_map))
      return false;
    if (!(consistency_level == rhs.consistency_level))
  ...
  bool operator < (const Cassandra_atomic_batch_mutate_args & ) const;
...
class Cassandra_atomic_batch_mutate_pargs {
 public:


  virtual ~Cassandra_atomic_batch_mutate_pargs() throw() {}
...
typedef struct _Cassandra_atomic_batch_mutate_result__isset {
  _Cassandra_atomic_batch_mutate_result__isset() : ire(false), ue(false), te(false) {}
  bool ire;
  bool ue;
  bool te;
} _Cassandra_atomic_batch_mutate_result__isset;

class Cassandra_atomic_batch_mutate_result {
 public:

  Cassandra_atomic_batch_mutate_result() {
  }

  virtual ~Cassandra_atomic_batch_mutate_result() throw() {}

  InvalidRequestException ire;
  UnavailableException ue;
  TimedOutException te;

  _Cassandra_atomic_batch_mutate_result__isset __isset;
  ...
  bool operator == (const Cassandra_atomic_batch_mutate_result & rhs) const
  {
    if (!(ire == rhs.ire))
      return false;
    if (!(ue == rhs.ue))
  ...
  bool operator < (const Cassandra_atomic_batch_mutate_result & ) const;
...
typedef struct _Cassandra_atomic_batch_mutate_presult__isset {
  _Cassandra_atomic_batch_mutate_presult__isset() : ire(false), ue(false), te(false) {}
  bool ire;
  bool ue;
  bool te;
} _Cassandra_atomic_batch_mutate_presult__isset;

class Cassandra_atomic_batch_mutate_presult {
 public:


  virtual ~Cassandra_atomic_batch_mutate_presult() throw() {}

  InvalidRequestException ire;
  UnavailableException ue;
  TimedOutException te;

  _Cassandra_atomic_batch_mutate_presult__isset __isset;
...
class Cassandra_trace_next_query_args {
 public:
  ...
  Cassandra_trace_next_query_args() {
  }

  virtual ~Cassandra_trace_next_query_args() throw() {}


  bool operator == (const Cassandra_trace_next_query_args & /* rhs */) const
  {
    return true;
  }
  bool operator != (const Cassandra_trace_next_query_args &rhs) const {
  ...
  bool operator < (const Cassandra_trace_next_query_args & ) const;
...
class Cassandra_trace_next_query_pargs {
 public:


  virtual ~Cassandra_trace_next_query_pargs() throw() {}
...
typedef struct _Cassandra_trace_next_query_result__isset {
  _Cassandra_trace_next_query_result__isset() : success(false) {}
  bool success;
} _Cassandra_trace_next_query_result__isset;

class Cassandra_trace_next_query_result {
 public:

  Cassandra_trace_next_query_result() : success() {
  }

  virtual ~Cassandra_trace_next_query_result() throw() {}

  std::string success;

  _Cassandra_trace_next_query_result__isset __isset;

  void __set_success(const std::string& val) {
    success = val;
  }

  bool operator == (const Cassandra_trace_next_query_result & rhs) const
  {
    if (!(success == rhs.success))
      return false;
    return true;
  ...
  bool operator < (const Cassandra_trace_next_query_result & ) const;
...
typedef struct _Cassandra_trace_next_query_presult__isset {
  _Cassandra_trace_next_query_presult__isset() : success(false) {}
  bool success;
} _Cassandra_trace_next_query_presult__isset;

class Cassandra_trace_next_query_presult {
 public:


  virtual ~Cassandra_trace_next_query_presult() throw() {}

  std::string* success;

  _Cassandra_trace_next_query_presult__isset __isset;
...
class Cassandra_describe_splits_ex_args {
 public:
  ...
  Cassandra_describe_splits_ex_args() : cfName(), start_token(), end_token(), keys_per_split(0) {
  }

  virtual ~Cassandra_describe_splits_ex_args() throw() {}
  ...
  bool operator == (const Cassandra_describe_splits_ex_args & rhs) const
  {
    if (!(cfName == rhs.cfName))
      return false;
    if (!(start_token == rhs.start_token))
  ...
  bool operator < (const Cassandra_describe_splits_ex_args & ) const;
...
class Cassandra_describe_splits_ex_pargs {
 public:


  virtual ~Cassandra_describe_splits_ex_pargs() throw() {}
...
typedef struct _Cassandra_describe_splits_ex_result__isset {
  _Cassandra_describe_splits_ex_result__isset() : success(false), ire(false) {}
  bool success;
  bool ire;
} _Cassandra_describe_splits_ex_result__isset;

class Cassandra_describe_splits_ex_result {
 public:

  Cassandra_describe_splits_ex_result() {
  }

  virtual ~Cassandra_describe_splits_ex_result() throw() {}

  std::vector<CfSplit>  success;
  InvalidRequestException ire;

  _Cassandra_describe_splits_ex_result__isset __isset;

  void __set_success(const std::vector<CfSplit> & val) {
    success = val;
  }
  ...
  bool operator == (const Cassandra_describe_splits_ex_result & rhs) const
  {
    if (!(success == rhs.success))
      return false;
    if (!(ire == rhs.ire))
  ...
  bool operator < (const Cassandra_describe_splits_ex_result & ) const;
...
typedef struct _Cassandra_describe_splits_ex_presult__isset {
  _Cassandra_describe_splits_ex_presult__isset() : success(false), ire(false) {}
  bool success;
  bool ire;
} _Cassandra_describe_splits_ex_presult__isset;

class Cassandra_describe_splits_ex_presult {
 public:


  virtual ~Cassandra_describe_splits_ex_presult() throw() {}

  std::vector<CfSplit> * success;
  InvalidRequestException ire;

  _Cassandra_describe_splits_ex_presult__isset __isset;
...
class Cassandra_execute_cql3_query_args {
 public:
  ...
  Cassandra_execute_cql3_query_args() : query(), compression((Compression::type)0), consistency((ConsistencyLevel::type)0) {
  }

  virtual ~Cassandra_execute_cql3_query_args() throw() {}
  ...
  bool operator == (const Cassandra_execute_cql3_query_args & rhs) const
  {
    if (!(query == rhs.query))
      return false;
    if (!(compression == rhs.compression))
  ...
  bool operator < (const Cassandra_execute_cql3_query_args & ) const;
...
class Cassandra_execute_cql3_query_pargs {
 public:


  virtual ~Cassandra_execute_cql3_query_pargs() throw() {}
...
typedef struct _Cassandra_execute_cql3_query_result__isset {
  _Cassandra_execute_cql3_query_result__isset() : success(false), ire(false), ue(false), te(false), sde(false) {}
  bool success;
  bool ire;
  bool ue;
  bool te;
  bool sde;
} _Cassandra_execute_cql3_query_result__isset;

class Cassandra_execute_cql3_query_result {
 public:

  Cassandra_execute_cql3_query_result() {
  }

  virtual ~Cassandra_execute_cql3_query_result() throw() {}
  ...
  _Cassandra_execute_cql3_query_result__isset __isset;
  ...
  bool operator == (const Cassandra_execute_cql3_query_result & rhs) const
  {
    if (!(success == rhs.success))
      return false;
    if (!(ire == rhs.ire))
  ...
  bool operator < (const Cassandra_execute_cql3_query_result & ) const;
...
typedef struct _Cassandra_execute_cql3_query_presult__isset {
  _Cassandra_execute_cql3_query_presult__isset() : success(false), ire(false), ue(false), te(false), sde(false) {}
  bool success;
  bool ire;
  bool ue;
  bool te;
  bool sde;
} _Cassandra_execute_cql3_query_presult__isset;

class Cassandra_execute_cql3_query_presult {
 public:


  virtual ~Cassandra_execute_cql3_query_presult() throw() {}
  ...
  _Cassandra_execute_cql3_query_presult__isset __isset;
...
class Cassandra_prepare_cql3_query_args {
 public:
  ...
  Cassandra_prepare_cql3_query_args() : query(), compression((Compression::type)0) {
  }

  virtual ~Cassandra_prepare_cql3_query_args() throw() {}
  ...
  bool operator == (const Cassandra_prepare_cql3_query_args & rhs) const
  {
    if (!(query == rhs.query))
      return false;
    if (!(compression == rhs.compression))
  ...
  bool operator < (const Cassandra_prepare_cql3_query_args & ) const;
...
class Cassandra_prepare_cql3_query_pargs {
 public:


  virtual ~Cassandra_prepare_cql3_query_pargs() throw() {}
...
typedef struct _Cassandra_prepare_cql3_query_result__isset {
  _Cassandra_prepare_cql3_query_result__isset() : success(false), ire(false) {}
  bool success;
  bool ire;
} _Cassandra_prepare_cql3_query_result__isset;

class Cassandra_prepare_cql3_query_result {
 public:

  Cassandra_prepare_cql3_query_result() {
  }

  virtual ~Cassandra_prepare_cql3_query_result() throw() {}

  CqlPreparedResult success;
  InvalidRequestException ire;

  _Cassandra_prepare_cql3_query_result__isset __isset;
  ...
  bool operator == (const Cassandra_prepare_cql3_query_result & rhs) const
  {
    if (!(success == rhs.success))
      return false;
    if (!(ire == rhs.ire))
  ...
  bool operator < (const Cassandra_prepare_cql3_query_result & ) const;
...
typedef struct _Cassandra_prepare_cql3_query_presult__isset {
  _Cassandra_prepare_cql3_query_presult__isset() : success(false), ire(false) {}
  bool success;
  bool ire;
} _Cassandra_prepare_cql3_query_presult__isset;

class Cassandra_prepare_cql3_query_presult {
 public:


  virtual ~Cassandra_prepare_cql3_query_presult() throw() {}

  CqlPreparedResult* success;
  InvalidRequestException ire;

  _Cassandra_prepare_cql3_query_presult__isset __isset;
...
class Cassandra_execute_prepared_cql3_query_args {
 public:
  ...
  Cassandra_execute_prepared_cql3_query_args() : itemId(0), consistency((ConsistencyLevel::type)0) {
  }

  virtual ~Cassandra_execute_prepared_cql3_query_args() throw() {}
  ...
  bool operator == (const Cassandra_execute_prepared_cql3_query_args & rhs) const
  {
    if (!(itemId == rhs.itemId))
      return false;
    if (!(values == rhs.values))
  ...
  bool operator < (const Cassandra_execute_prepared_cql3_query_args & ) const;
...
class Cassandra_execute_prepared_cql3_query_pargs {
 public:


  virtual ~Cassandra_execute_prepared_cql3_query_pargs() throw() {}
...
typedef struct _Cassandra_execute_prepared_cql3_query_result__isset {
  _Cassandra_execute_prepared_cql3_query_result__isset() : success(false), ire(false), ue(false), te(false), sde(false) {}
  bool success;
  bool ire;
  bool ue;
  bool te;
  bool sde;
} _Cassandra_execute_prepared_cql3_query_result__isset;

class Cassandra_execute_prepared_cql3_query_result {
 public:

  Cassandra_execute_prepared_cql3_query_result() {
  }

  virtual ~Cassandra_execute_prepared_cql3_query_result() throw() {}
  ...
  _Cassandra_execute_prepared_cql3_query_result__isset __isset;
  ...
  bool operator == (const Cassandra_execute_prepared_cql3_query_result & rhs) const
  {
    if (!(success == rhs.success))
      return false;
    if (!(ire == rhs.ire))
  ...
  bool operator < (const Cassandra_execute_prepared_cql3_query_result & ) const;
...
typedef struct _Cassandra_execute_prepared_cql3_query_presult__isset {
  _Cassandra_execute_prepared_cql3_query_presult__isset() : success(false), ire(false), ue(false), te(false), sde(false) {}
  bool success;
  bool ire;
  bool ue;
  bool te;
  bool sde;
} _Cassandra_execute_prepared_cql3_query_presult__isset;

class Cassandra_execute_prepared_cql3_query_presult {
 public:


  virtual ~Cassandra_execute_prepared_cql3_query_presult() throw() {}
  ...
  _Cassandra_execute_prepared_cql3_query_presult__isset __isset;
...
class CassandraClient : virtual public CassandraIf {
 public:
  ...
  void recv_add();
  void cas(CASResult& _return, const std::string& key, const std::string& column_family, const std::vector<Column> & expected, const std::vector<Column> & updates, const ConsistencyLevel::type serial_consistency_level, const ConsistencyLevel::type commit_consistency_level);
  void send_cas(const std::string& key, const std::string& column_family, const std::vector<Column> & expected, const std::vector<Column> & updates, const ConsistencyLevel::type serial_consistency_level, const ConsistencyLevel::type commit_consistency_level);
  void recv_cas(CASResult& _return);
  void remove(const std::string& key, const ColumnPath& column_path, const int64_t timestamp, const ConsistencyLevel::type consistency_level);
  ...
  void atomic_batch_mutate(const std::map<std::string, std::map<std::string, std::vector<Mutation> > > & mutation_map, const ConsistencyLevel::type consistency_level);
  void send_atomic_batch_mutate(const std::map<std::string, std::map<std::string, std::vector<Mutation> > > & mutation_map, const ConsistencyLevel::type consistency_level);
  void recv_atomic_batch_mutate();
  void truncate(const std::string& cfname);
  ...
  void trace_next_query(std::string& _return);
  void send_trace_next_query();
  void recv_trace_next_query(std::string& _return);
  void describe_splits_ex(std::vector<CfSplit> & _return, const std::string& cfName, const std::string& start_token, const std::string& end_token, const int32_t keys_per_split);
  void send_describe_splits_ex(const std::string& cfName, const std::string& start_token, const std::string& end_token, const int32_t keys_per_split);
  void recv_describe_splits_ex(std::vector<CfSplit> & _return);
  void system_add_column_family(std::string& _return, const CfDef& cf_def);
  ...
  void execute_cql3_query(CqlResult& _return, const std::string& query, const Compression::type compression, const ConsistencyLevel::type consistency);
  void send_execute_cql3_query(const std::string& query, const Compression::type compression, const ConsistencyLevel::type consistency);
  void recv_execute_cql3_query(CqlResult& _return);
  void prepare_cql_query(CqlPreparedResult& _return, const std::string& query, const Compression::type compression);
  ...
  void prepare_cql3_query(CqlPreparedResult& _return, const std::string& query, const Compression::type compression);
  void send_prepare_cql3_query(const std::string& query, const Compression::type compression);
  void recv_prepare_cql3_query(CqlPreparedResult& _return);
  void execute_prepared_cql_query(CqlResult& _return, const int32_t itemId, const std::vector<std::string> & values);
  ...
  void execute_prepared_cql3_query(CqlResult& _return, const int32_t itemId, const std::vector<std::string> & values, const ConsistencyLevel::type consistency);
  void send_execute_prepared_cql3_query(const int32_t itemId, const std::vector<std::string> & values, const ConsistencyLevel::type consistency);
  void recv_execute_prepared_cql3_query(CqlResult& _return);
  void set_cql_version(const std::string& version);
...
class CassandraProcessor : public ::apache::thrift::TDispatchProcessor {
 ...
 private:
  ...
  void process_cas(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext);
  ...
  void process_trace_next_query(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext);
  void process_describe_splits_ex(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext);
  ...
  void process_execute_cql3_query(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext);
  ...
  void process_prepare_cql3_query(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext);
  ...
  void process_execute_prepared_cql3_query(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext);
 ...
 public:
  CassandraProcessor(boost::shared_ptr<CassandraIf> iface) :
    ...
    processMap_["cas"] = &CassandraProcessor::process_cas;
    ...
    processMap_["trace_next_query"] = &CassandraProcessor::process_trace_next_query;
    processMap_["describe_splits_ex"] = &CassandraProcessor::process_describe_splits_ex;
    ...
    processMap_["execute_cql3_query"] = &CassandraProcessor::process_execute_cql3_query;
    processMap_["prepare_cql_query"] = &CassandraProcessor::process_prepare_cql_query;
    processMap_["prepare_cql3_query"] = &CassandraProcessor::process_prepare_cql3_query;
    processMap_["execute_prepared_cql_query"] = &CassandraProcessor::process_execute_prepared_cql_query;
    processMap_["execute_prepared_cql3_query"] = &CassandraProcessor::process_execute_prepared_cql3_query;
...
class CassandraMultiface : virtual public CassandraIf {
 ...
 public:
  ...
  void cas(CASResult& _return, const std::string& key, const std::string& column_family, const std::vector<Column> & expected, const std::vector<Column> & updates, const ConsistencyLevel::type serial_consistency_level, const ConsistencyLevel::type commit_consistency_level) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->cas(_return, key, column_family, expected, updates, serial_consistency_level, commit_consistency_level);
    }
    ifaces_[i]->cas(_return, key, column_family, expected, updates, serial_consistency_level, commit_consistency_level);
    return;
  }
  ...
  void atomic_batch_mutate(const std::map<std::string, std::map<std::string, std::vector<Mutation> > > & mutation_map, const ConsistencyLevel::type consistency_level) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->atomic_batch_mutate(mutation_map, consistency_level);
    }
    ifaces_[i]->atomic_batch_mutate(mutation_map, consistency_level);
  }
  ...
  void trace_next_query(std::string& _return) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->trace_next_query(_return);
    }
    ifaces_[i]->trace_next_query(_return);
    return;
  }
  ...
  void describe_splits_ex(std::vector<CfSplit> & _return, const std::string& cfName, const std::string& start_token, const std::string& end_token, const int32_t keys_per_split) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->describe_splits_ex(_return, cfName, start_token, end_token, keys_per_split);
    }
    ifaces_[i]->describe_splits_ex(_return, cfName, start_token, end_token, keys_per_split);
    return;
  }
  ...
  void execute_cql3_query(CqlResult& _return, const std::string& query, const Compression::type compression, const ConsistencyLevel::type consistency) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->execute_cql3_query(_return, query, compression, consistency);
    }
    ifaces_[i]->execute_cql3_query(_return, query, compression, consistency);
    return;
  }
  ...
  void prepare_cql3_query(CqlPreparedResult& _return, const std::string& query, const Compression::type compression) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->prepare_cql3_query(_return, query, compression);
    }
    ifaces_[i]->prepare_cql3_query(_return, query, compression);
    return;
  }
  ...
  void execute_prepared_cql3_query(CqlResult& _return, const int32_t itemId, const std::vector<std::string> & values, const ConsistencyLevel::type consistency) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->execute_prepared_cql3_query(_return, itemId, values, consistency);
    }
    ifaces_[i]->execute_prepared_cql3_query(_return, itemId, values, consistency);
    return;
  }
