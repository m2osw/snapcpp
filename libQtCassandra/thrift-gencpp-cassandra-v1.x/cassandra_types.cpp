...
const char* CqlPreparedResult::ascii_fingerprint = "02505A8B081D8C27953030EC5AE071E1";
const uint8_t CqlPreparedResult::binary_fingerprint[16] = {0x02,0x50,0x5A,0x8B,0x08,0x1D,0x8C,0x27,0x95,0x30,0x30,0xEC,0x5A,0xE0,0x71,0xE1};
...
uint32_t CqlPreparedResult::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  if (this->__isset.variable_types) {
    xfer += oprot->writeFieldBegin("variable_types", ::apache::thrift::protocol::T_LIST, 3);
    {
      ...
      for (_iter142 = this->variable_types.begin(); _iter142 != this->variable_types.end(); ++_iter142)
      {
