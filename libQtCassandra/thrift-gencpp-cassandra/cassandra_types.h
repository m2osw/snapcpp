...
typedef struct _CqlPreparedResult__isset {
  _CqlPreparedResult__isset() : variable_types(false) {}
  bool variable_types;
...
class CqlPreparedResult {
 public:
  ...
  static const char* ascii_fingerprint; // = "02505A8B081D8C27953030EC5AE071E1";
  static const uint8_t binary_fingerprint[16]; // = {0x02,0x50,0x5A,0x8B,0x08,0x1D,0x8C,0x27,0x95,0x30,0x30,0xEC,0x5A,0xE0,0x71,0xE1};
